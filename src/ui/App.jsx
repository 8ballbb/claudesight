...
const THEME_KEY = 'claudesight.theme'
  ...
  return (
    <main className={s.page}>
      <header className={s.header}>
        <h1 className={s.wordmark}>claude·sight</h1>
        <nav className={s.nav}>
          <button
        ...
        {server === 'live' && (
          quitting ? (
            ...
            <button className={s.linkQuiet} onClick={() => setQuitting(true)} title="Stop the claudesight server">
              quit
            </button>
          )
        )}
      ...
      {server === 'gone' && (
        <p className={s.serverGone}>
          <b>The claudesight server has stopped.</b> This page is showing what it last read
