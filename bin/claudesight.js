...
if (process.platform !== 'darwin') {
  console.error(`claudesight supports macOS only at the moment; this is ${process.platform}.`)
  console.error('Nothing else has been tested, and it reads and writes files you rely on.')
  console.error('Track or request other platforms: https://github.com/8ballbb/claudesight/issues')
  process.exit(1)
}
...
try {
  ...
  if (err.code === 'EADDRINUSE') {
    ...
    console.error(`Stop it, or choose another: claudesight --port ${port + 1}`)
    process.exit(1)
  }
  throw err
}
